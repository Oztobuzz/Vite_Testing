...
// import './App.css';
import {CardList_vehicle} from '../components/card_list/card_list.component';
...
class Vehicle extends Component{
  ...
  componentDidMount(){
    let monsterFetch = fetch("https://raw.githubusercontent.com/Oztobuzz/MWC_2.0/main/Codespace/data/Vehicle.json");
  ...
  render(){
    ...
    return (
      <div className="App">
        ...
        <CardList_vehicle className="cardlist" monsters = {filteredMonsters}></CardList_vehicle>
